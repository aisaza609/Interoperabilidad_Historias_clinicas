...
jq '.channel_group.groups.Application.groups."org0-example-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "172.20.10.9","port": 7003}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
